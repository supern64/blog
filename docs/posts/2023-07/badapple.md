...
```
Unfortunately, I don't own a real micro:bit to test this on and see if it will run (which is ironic considering I made this solely to get it running on the real thing in one script), but I can still show what it would look like if it fit. Enjoy!
